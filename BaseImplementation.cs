namespace Bristows.TRACR.DAL.Infrastructure
{
                                                             ...
                                                             where TR : DbContext
    {
        ...
        public virtual async Task<IEnumerable<TE?>> GetAllAsync(bool disableTracking = true) => disableTracking ? await _dbSet.AsNoTracking().ToListAsync() : await _dbSet.ToListAsync();
